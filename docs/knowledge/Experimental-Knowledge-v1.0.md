# Experimental Knowledge Base v1.0

**Status:** experimental  
**Version:** 1.0  
**Audience:** DAOS agents, DecisionEngine, ResearchLab  
**Authority:** subordinate to [DAOS_ARCHITECTURE_CONSTITUTION_V3.md](../architecture/DAOS_ARCHITECTURE_CONSTITUTION_V3.md)  
...
- [DAOS_ARCHITECTURE_CONSTITUTION_V3.md](../architecture/DAOS_ARCHITECTURE_CONSTITUTION_V3.md) — SPEC-005 Decision example references rules here  
- [experimental-artifacts/](./experimental-artifacts/) — per-entry YAML fragments  
