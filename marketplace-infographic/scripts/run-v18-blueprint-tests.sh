...
SPECS=(
  ...
  src/lib/render-blueprint/knowledge-versioning.spec.ts
  src/lib/render-blueprint/knowledge-learning.spec.ts
  ...
  src/lib/render-blueprint/knowledge-retrieval-stage.spec.ts
