...
export const V18_TEST_REGISTRY: TestSpecEntry[] = [
  ...
  { id: "lighting-director-agent", path: `${BP}/lighting-director-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.14", description: "Lighting Director Agent", usesLlm: false },
  { id: "camera-director-agent", path: `${BP}/camera-director-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.15", description: "Camera Director Agent", usesLlm: false },
  { id: "material-director-agent", path: `${BP}/material-director-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.16", description: "Material Director Agent", usesLlm: false },
  { id: "typography-director-agent", path: `${BP}/typography-director-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.17", description: "Typography Director Agent", usesLlm: false },
  ...
  { id: "commercial-critic-agent", path: `${BP}/commercial-critic-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.22", description: "Commercial Critic Agent", usesLlm: false },
  { id: "senior-art-director-agent", path: `${BP}/senior-art-director-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.23", description: "Senior Art Director Agent", usesLlm: false },
  { id: "chief-design-director-agent", path: `${BP}/chief-design-director-agent.spec.ts`, category: TestCategory.AGENT, chapter: "7.24", description: "Chief Design Director Agent", usesLlm: false },
