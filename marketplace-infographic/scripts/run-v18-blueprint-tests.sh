...
SPECS=(
  ...
  src/lib/render-blueprint/vision-validation-stage.spec.ts
  ...
  src/lib/render-blueprint/visual-story-director-agent.spec.ts
  ...
  src/lib/render-blueprint/camera-director-agent.spec.ts
  src/lib/render-blueprint/material-director-agent.spec.ts
  ...
  src/lib/render-blueprint/vision-critic-agent.spec.ts
