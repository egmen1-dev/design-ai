...
export const PRODUCT_TARGET_HEIGHT_RATIO = 0.78;
export const PRODUCT_TARGET_MAX_HEIGHT_PX = Math.round(WB_COVER.height * 0.88);
export const PRODUCT_BOTTOM_PAD_PX = Math.round(WB_COVER.height * 0.028);
