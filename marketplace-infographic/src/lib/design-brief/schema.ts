...
export const designBriefSchema = z.object({
  ...
  selectedArchetypeId: z.string().max(40).optional(),
  artDirectorMode: z.string().max(40).optional(),
  conceptRenderQueue: z.array(z.string().max(40)).max(8).optional(),
  designDnaOverride: z.record(z.number()).optional(),
