...
export const RENDER_PROFILES: Record<RenderProfileId, RenderProfile> = {
  industrial: {
    ...
    environmentHint: "neutral grey studio cyclorama, clean floor, soft gradient backdrop",
  ...
  construction: {
    ...
    label: "Construction",
    preferredModel: "kontext",
    environmentHint: "garage workshop floor, neutral walls, domestic power tools setting",
