...
export const BENCHMARK_DAOS_ASPECT_RATIO_PLACEMENT_ENV: Record<string, string> = {
  ...
  DAOS_COMPOSITOR_ASYMMETRIC_LIMITS: "0",
};
...
export const BENCHMARK_DAOS_WIDE_PRODUCT_LAYOUT_ENV: Record<string, string> = {
