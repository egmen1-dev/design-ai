/**
 * Attention competition pixel metrics — shared by production diagnostics and benchmarks.
 */
import sharp from "sharp";
import { resolveMeasurementZones } from "@/lib/commercial-fidelity/expectations";
import { measureImageCommercialSignals } from "@/lib/commercial-fidelity/measure";
